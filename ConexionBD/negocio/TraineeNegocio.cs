    ...
    public class TraineeNegocio
    {
        public void actualizar(Trainee user)
        {
            ...
            {                
                ...
                //datos.setearParametro("@imagen",user.ImagenPerfil != null ? user.ImagenPerfil : (object)DBNull.Value); //EL DBNULL hay que castearlo a object sino sale error
                datos.setearParametro("@imagen", (object)user.ImagenPerfil ?? DBNull.Value); //Nuevo Operador "COALESCING" (es como un condicional, pero no evalua la parte derecha si la parte izquierda es distinto de null)
